...
SRC_URI="https://github.com/mate-desktop/mate-control-center/releases/download/v${PV}/mate-control-center-${PV}.tar.xz"
...
COMMON_DEPEND="
	...
	>=mate-base/libmatekbd-${MATE_MIN_VER}
	>=mate-base/mate-desktop-${MATE_MIN_VER}
	>=mate-base/caja-${MATE_MIN_VER}
	>=mate-base/mate-menus-${MATE_MIN_VER}
